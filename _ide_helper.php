...
')
     ...
     */ 
        ...
        {
                        /** @var \Rootsoft\Algorand\Algorand $instance */
                        return $instance->applicationManager();
        }
                    /**
         ...
         * @return \Rootsoft\Algorand\PendingTransaction|string 
         * @throws AlgorandException
         * @static 
         */ 
        public static function sendTransactions($transactions, $waitForConfirmation = false, $timeout = 5)
        {
                        /** @var \Rootsoft\Algorand\Algorand $instance */
                        return $instance->sendTransactions($transactions, $waitForConfirmation, $timeout);
        }
                    /**
         ...
         *
         * @param \Rootsoft\Algorand\Account $account
         * @param \Rootsoft\Algorand\ParticipationPublicKey $votePK
         * @param \Rootsoft\Algorand\VRFPublicKey $selectionPK
         * @param int $voteFirst
         * @param int $voteLast
         ...
         * @static 
         */ 
        public static function registerOnline($account, $votePK, $selectionPK, $voteFirst, $voteLast, $voteKeyDilution = 10000, $waitForConfirmation = false, $timeout = 5)
        {
                        /** @var \Rootsoft\Algorand\Algorand $instance */
                        return $instance->registerOnline($account, $votePK, $selectionPK, $voteFirst, $voteLast, $voteKeyDilution, $waitForConfirmation, $timeout);
        }
                    /**
         ...
         * @static 
         */ 
        public static function registerOffline($account, $waitForConfirmation = false, $timeout = 5)
        {
                        /** @var \Rootsoft\Algorand\Algorand $instance */
                        return $instance->registerOffline($account, $waitForConfirmation, $timeout);
        }
